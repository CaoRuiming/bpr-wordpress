...
<?php
     ...
     *
     * @hooked BPRWP\Theme\Index\render_header - 10
     */
        ...
        <div class="content">
                ...
                <div class="posts">
                    <?php while (have_posts()) : the_post() ?>
                        <?php
                             ...
                             *
                             * @hooked BPRWP\Theme\App\Structure\render_post_thumbnail - 10
                             */
            ...
            <?php else : ?>
                <?php
                     ...
                     *
                     * @hooked BPRWP\Theme\App\Structure\render_empty_content - 10
                     */
