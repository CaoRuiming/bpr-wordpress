...
<div class="container-fluid">
    <div class="row search-results">
        ...
        <div class="content col-lg-10">
            ...
            <div class="result">
                <p class="date">August 10th, 2019</p>
                <div class="info">
                    <p class="title">A World United</p>
                    <p class="tag spacing">World</p>
                    <p class="description spacing">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean condimentum lorem arcu, quis commodo turpis semper in. Etiam pellentesque, ante aliquam faucibus tempor, orci mi molestie tellus, sit amet ornare mauris libero sed lectus. Mauris eu nunc nulla. Ut orci justo, scelerisque in velit a, accumsan efficitur risus. Praesent eget metus feugiat, imperdiet felis ut, accumsan libero. Sed non turpis eleifend quam...</p>
