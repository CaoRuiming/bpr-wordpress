...
namespace BPRWP\Theme\App\Setup;
...
add_filter('theme/index/sidebar/visibility', 'BPRWP\Theme\App\Setup\show_index_sidebar');
add_filter('theme/single/sidebar/visibility', 'BPRWP\Theme\App\Setup\show_index_sidebar');
...
add_filter('excerpt_length', 'BPRWP\Theme\App\Setup\modify_excerpt_length');
