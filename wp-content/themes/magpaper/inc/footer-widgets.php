...
class Magpaper_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'magpaper';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'magpaper' ), $i ),
...
// Initialize.
$magpaper_footer_widgets = new Magpaper_Footer_Widgets();
