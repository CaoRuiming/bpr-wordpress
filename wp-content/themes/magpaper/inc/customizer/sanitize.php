...
if ( ! function_exists( 'magpaper_sanitize_select' ) ) :
	/**
	 ...
	 */
	function magpaper_sanitize_select( $input, $setting ) {
...
if ( ! function_exists( 'magpaper_sanitize_image' ) ) :
	/**
	 ...
	 */
	function magpaper_sanitize_image( $image, $setting ) {
		/*
...
if ( ! function_exists( 'magpaper_sanitize_number_range' ) ) :
	/**
	 ...
	 *                    the setting default.
	 */
	function magpaper_sanitize_number_range( $number, $setting ) {
...
if ( ! function_exists( 'magpaper_sanitize_page' ) ) :
	/**
	* Sanitizes page/post
	...
	* @since Magpaper 1.0.0
	*/
	function magpaper_sanitize_page( $input ) {
...
if ( ! function_exists( 'magpaper_sanitize_checkbox' ) ) :
	/**
	 * Sanitize checkbox.
	 *
	 * @since Magpaper 1.0.0
	 ...
	 */
	function magpaper_sanitize_checkbox( $checked ) {
...
if ( ! function_exists( 'magpaper_sanitize_category_list' ) ) :
	/**
	 ...
	 * @since Magpaper 1.0.0
	 */
	function magpaper_sanitize_category_list( $input ) {
		if ( $input != '' ) {
			$args = array(
							'type'			=> 'post',
							'child_of'      => 0,
...
if( ! function_exists( 'magpaper_sanitize_single_category' ) ) :
	/**
	 ...
	 * @since Magpaper 1.0.0
	 */
	function magpaper_sanitize_single_category( $input ) {
		if ( $input != '' ) {
			$args = array(
							'type'			=> 'post',
							'child_of'      => 0,
...
if ( ! function_exists( 'magpaper_santize_allow_tag' ) ) :
	/**
	 ...
	 */
	function magpaper_santize_allow_tag( $input ) {
 ...
 * @return boolean    
 */
function magpaper_sanitize_switch_control( $input ) {
