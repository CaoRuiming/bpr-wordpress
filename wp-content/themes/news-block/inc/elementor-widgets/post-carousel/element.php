 ...
 * 
 */
class News_Block_Post_Carousel_Element extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Post Carousel', 'news-block' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'blockLayout',
            [
                'label' => esc_html__( 'Layouts', 'news-block' ),
                'type' => 'RADIOIMAGE',
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => esc_html__( 'News Block Post Carousel Title', 'news-block' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Carousel Options', 'news-block' ),
                'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
            ]
        );
            ...
            $this->add_control(
                'carouselType',
                [
                    'label' => esc_html__( 'Enable fade animation', 'news-block' ),
                    'type' => \Elementor\Controls_Manager::SWITCHER,
                    'label_on' => esc_html__( 'Show', 'news-block' ),
                    'label_off' => esc_html__( 'Hide', 'news-block' ),
                    'show' => esc_html__( 'Show', 'news-block' ),
            ...
            $this->add_control(
                'carouselControls',
                [
                    'label' => esc_html__( 'Show control buttons', 'news-block' ),
                    'type' => \Elementor\Controls_Manager::SWITCHER,
                    'label_on' => esc_html__( 'Show', 'news-block' ),
                    'label_off' => esc_html__( 'Hide', 'news-block' ),
                    'show' => esc_html__( 'Show', 'news-block' ),
            ...
            $this->add_control(
                'carouselLoop',
                [
                    'label' => esc_html__( 'Enable items loop', 'news-block' ),
                    'type' => \Elementor\Controls_Manager::SWITCHER,
                    'label_on' => esc_html__( 'Show', 'news-block' ),
                    'label_off' => esc_html__( 'Hide', 'news-block' ),
                    'show' => esc_html__( 'Show', 'news-block' ),
        ...
        $this->end_controls_section(); // color settings ends
    }
    ...
    protected function render() {
        ...
        $carouselAttr = ' data-loop='.esc_attr( ( $carouselLoop ) ? '1' : '0' ).' data-control='.esc_attr( ( $carouselControls ) ? '1' : '0' ).' data-type='.esc_attr( ( $carouselType ) ? '1' : '0' );
        
        echo '<div id="blaze-mag-modules-post-carousel-block-'.esc_attr( $element_id ).'" class="blaze-mag-modules-post-carousel-block block-'.esc_attr( $element_id ).' bmm-block bmm-block-post-carousel--'.esc_html( $blockLayout ).' bmm-block-image-hover--'.esc_html( $imageHoverType ).'">';
            if( !empty( $blockTitle ) ) {
                echo '<h2 class="bmm-block-title layout--default">'.esc_html( $blockTitle ).'</h2>';
            }
            // include template file w.r.t  layout value
            include( NEWS_BLOCKS_INCLUDES_PATH .'elementor-widgets/post-carousel/'.$blockLayout.'/'.$blockLayout.'.php' );
        echo '</div><!-- #blaze-mag-modules-post-carousel-block -->';
    }
}