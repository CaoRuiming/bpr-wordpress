 ...
 * 
 */
class News_Block_Post_Grid_Alter_Element extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Post Grid Alter', 'news-block' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => esc_html__( 'News Block Post Grid Alter Title', 'news-block' ),
    ...
    protected function render() {
        ...
        echo '<div id="blaze-mag-modules-post-grid-alter-block-'.esc_attr( $element_id ).'" class="blaze-mag-modules-post-grid-alter-block block-'.esc_attr( $element_id ).' bmm-block bmm-block-post-grid-alter--'.esc_html( $blockLayout ).' bmm-block-image-hover--'.esc_html( $imageHoverType ).'">';
            if( !empty( $blockTitle ) ) {
                echo '<h2 class="bmm-block-title layout--default">'.esc_html( $blockTitle ).'</h2>';
            }
            // include template file w.r.t  layout value
            include( NEWS_BLOCKS_INCLUDES_PATH .'elementor-widgets/post-grid-alter/'.$blockLayout.'/'.$blockLayout.'.php' );
        echo '</div><!-- #blaze-mag-modules-post-grid-alter-block -->';
    }
}