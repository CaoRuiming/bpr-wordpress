	...
	<form method='post' action='<?php esc_url($_SERVER["REQUEST_URI"]); ?>'>
		...
		<div style="background-color:#fff;padding:8px;border: 1px solid #CCCCCC;"><br />
			...
			<table><tr><td>
				...
				<?php
                $show_enable = isset($_POST['wpeppsub_button_show']) ? intval($_POST['wpeppsub_button_show']) : 0;
				?>
				
				Show Name: </td><td><input type="checkbox" name="wpeppsub_button_show" value="1" <?php checked($show_enable, 1); ?>></td><td> Optional - Show the name of the item above the button.
				...
				<select name="wpeppsub_button_language" style="width: 190px">
                    <?php $wpeppsub_button_language = isset($_POST['wpeppsub_button_language']) ? sanitize_text_field($_POST['wpeppsub_button_language']) : -1; ?>
				...
				<select name="wpeppsub_button_currency" style="width: 190px">
                    <?php $wpeppsub_button_currency = isset($_POST['wpeppsub_button_currency']) ? sanitize_text_field($_POST['wpeppsub_button_currency']) : -1; ?>
				...
				<select name="wpeppsub_button_buttonsize" style="width:190px;">
                    <?php $wpeppsub_button_buttonsize = isset($_POST['wpeppsub_button_buttonsize']) ? sanitize_text_field($_POST['wpeppsub_button_buttonsize']) : -1; ?>
				...
				<select name="wpeppsub_p3">
                    <?php $wpeppsub_p3 = isset($_POST['wpeppsub_p3']) ? sanitize_text_field($_POST['wpeppsub_p3']) : -1; ?>
					<?php for ($i = 1; $i <= 30; $i++) { ?>
				...
				<select name="wpeppsub_t3">
                    <?php $wpeppsub_t3 = isset($_POST['wpeppsub_t3']) ? sanitize_text_field($_POST['wpeppsub_t3']) : -1; ?>
				...
				<select name="wpeppsub_srt">
                    <?php $wpeppsub_srt = isset($_POST['wpeppsub_srt']) ? sanitize_text_field($_POST['wpeppsub_srt']) : -1; ?>
				...
				<?php
                $wpeppsub_trial_1_enable = isset($_POST['wpeppsub_trial_1']) ? intval($_POST['wpeppsub_trial_1']) : 0;
				?>				
				
				
				I want to offer a trial period: </td><td>
				<input type="checkbox" name="wpeppsub_trial_1" value="1" <?php checked($wpeppsub_trial_1_enable, 1); ?>></td><td>Optional</td><td>
				...
				<select name="wpeppsub_p1">
                    <?php $wpeppsub_p1 = isset($_POST['wpeppsub_p1']) ? sanitize_text_field($_POST['wpeppsub_p1']) : -1; ?>
					<?php for ($i = 1; $i <= 52; $i++) { ?>
						<option value="<?php echo esc_attr($i); ?>" <?php if($wpeppsub_p1 == $i) { echo "SELECTED"; } ?>><?php echo esc_html($i); ?></option>
					<?php } ?>
				</select>
				
				<select name="wpeppsub_t1">
                    <?php $wpeppsub_t1 = isset($_POST['wpeppsub_t1']) ? sanitize_text_field($_POST['wpeppsub_t1']) : -1; ?>
