...
<div id="dashboard-widgets-wrap">
	...
	<div style="text-align: center; margin-top: 30px;">
		<div class="ajdg-sales-widget" style="display: inline-block; margin-right:20px; width: 230px;">
			...
			<div class="cta"><a role="button" class="cta_button" href="https://ajdg.solutions/?add-to-cart=1124&pk_campaign=adrotatefree&pk_keyword=adrotatepro_page&pk_content=single_buy" target="_blank">Buy now for &euro; 39</a></div>
		</div>
		<div class="ajdg-sales-widget" style="display: inline-block; margin-right:20px; width: 230px;">
			...
			<div class="cta"><a role="button" class="cta_button" href="https://ajdg.solutions/?add-to-cart=1126&pk_campaign=adrotatefree&pk_keyword=adrotatepro_page&pk_content=duo_buy" target="_blank">Buy now for &euro; 49</a></div>
		</div>
		<div class="ajdg-sales-widget" style="display: inline-block; margin-right:20px; width: 230px;">
			...
			<div class="cta"><a role="button" class="cta_button" href="https://ajdg.solutions/?add-to-cart=1128&pk_campaign=adrotatefree&pk_keyword=adrotatepro_page&pk_content=multi_buy" target="_blank">Buy now for &euro; 99</a></div>
		</div>
		<div class="ajdg-sales-widget" style="display: inline-block; margin-right:20px; width: 230px;">
			...
			<div class="cta"><a role="button" class="cta_button" href="https://ajdg.solutions/?add-to-cart=1130&pk_campaign=adrotatefree&pk_keyword=adrotatepro_page&pk_content=developer_buy" target="_blank">Buy now for &euro; 199</a></div>
		</div>
	</div>
